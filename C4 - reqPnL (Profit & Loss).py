...
print("")
app.reqPnL(123, "DUXXXX123", "")                      #specifying the IBKR Account Number may be required
#app.reqPnLSingle(1234, "DUXXXX123", "", 265598)      #to specify PnL for a specific security 
